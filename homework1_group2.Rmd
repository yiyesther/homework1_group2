...
ggplot(top_25_beer,aes(y=fct_reorder(country,beer_servings),x=beer_servings))+
  geom_col(fill="green")+
  labs(title = "Nambian people drink more beer")
...
```{r,movie_q1}
# No. Not all the entries are distinct as the n_unique values do not match, indicating that several values were repeated.
