...
gss_email2 %>%
  ...
  geom_histogram(breaks = seq(min(as.numeric(email)), max(as.numeric(email)), 100)) +
...
email_ci_humanized[c(1)] <- Hours[c(1)]
email_ci_humanized[c(2)] <- Minutes[c(1)]
email_ci_humanized[c(3)] <- Hours[c(2)]
email_ci_humanized[c(4)] <- Minutes[c(2)]
