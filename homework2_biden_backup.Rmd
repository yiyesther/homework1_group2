...
margin_ci %>% 
  ...
  geom_line(aes(y=avg_approval_margin, group=1), color = "red") +
  geom_point(aes(y=avg_approval_margin, group=1), color = "red") +
  geom_smooth(aes(y=avg_approval_margin)) +
  geom_line(aes(y=ci_margin_up, group=1), color="red")+
  geom_line(aes(y=ci_margin_dw, group=1), color="red")+
  
  #add the aesthetics for the graph
  geom_hline(yintercept=0, linetype="solid", color = "yellow")+
  labs(title="Estimating Approval Margin (approve-disapprove) for Joe Biden",
       subtitle = "Weekly average of all polls",
       x = "Week of the year", 
       y = "Average Approval Margin (Approve - Disapprove") +
  annotate("text", x = 20, y = 20, label = "2021", color = 'blue',size = 3)+
  scale_y_continuous(
