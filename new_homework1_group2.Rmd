...
colnames(summarise_monthly_returns) <- c("Minimum Monthly Return [$]", "Maximum Monthly Return [$]", "Median of Monthly Return [$]", "Mean of Monthly Return [$]", "Standard Deviation of Monthly Return [$]")
  ##to add labs
...
myStocks_returns_monthly %>%
  ...
  labs(title = "Monthly return of each of the stocks", x = "Monthly return [$]", y = "Frequency")
...
> TYPE YOUR ANSWER AFTER (AND OUTSIDE!) THIS BLOCKQUOTE.
The risk of the stock can be determined by visually analyzing the proportion of the graph area that lies in the left of the y-axis. This determines how the stocks were performing and whether they were likely to produce negative returns. Based on this, the riskiest stock would be XOM, because its past performance indicates that it is quite likely that it produces negative returns. The least risky stock would be DPZ, because its past performance indicates that it is likely that it produces positive returns.
...
myStocks_returns_monthly %>% 
  ...
  geom_point() +
  geom_text_repel()+
  labs(title = "The risk of each of the stocks expressed as standard deviation", x = "Monthly return [$]", y = "Standard deviation [$]")
  


>>>>>>> 0aeca28a1e8e1c803966fe15d91d2db059c8b00c
```

What can you infer from this plot? Are there any stocks which, while being riskier, do not have a higher expected return?

> TYPE YOUR ANSWER AFTER (AND OUTSIDE!) THIS BLOCKQUOTE.
Based on this graph, ANF had a broad distribution of potential returns but not a higher expected return when compared to other stocks. Therefore it is high risk but not high expected return. 
